...
$$
\begin{eqnarray}
\lg{n!} &=& \lg{(\sqrt{2\pi{n}}(\frac{n}{e})^n(1 + \frac{1}{12n} + \frac{1}{288n^2} - \frac{139}{51840n^3} + \ldots))} \\\
&=& \lg{\sqrt{2\pi{n}}} + \lg{(\frac{n}{e})^n} + \lg{(1 + \frac{1}{12n} + \frac{1}{288n^2} - \frac{139}{51840n^3} + \ldots)} \\\
\end{eqnarray}
$$